-- =============================================================================
-- Fix Timezone in Views
-- Created: 2026-01-22
-- Purpose: Use Eastern time for "today" in views since college basketball games
--          are scheduled and displayed in US Eastern time
-- =============================================================================

-- Problem: Games stored with Eastern dates, but CURRENT_DATE uses server timezone (UTC)
-- Solution: Use (CURRENT_TIMESTAMP AT TIME ZONE 'America/New_York')::DATE for "today"

DROP VIEW IF EXISTS today_games CASCADE;
DROP VIEW IF EXISTS upcoming_games CASCADE;

-- Helper function already exists: american_odds_to_implied_prob
